 ...
 */
(function () {
    var noop, MediaCloudJSSDK, Event, TransStatusWatch, onload,type;
    noop = function () {};
     ...
     * @param {Function} callback
     */
    MediaCloudJSSDK.prototype.hiddenNativeBackBtnjs = function (callback) {
        normalEventBind(this._event, 'hiddenNativeBackBtnjs', callback);
        this._request('hiddenNativeBackBtnjs');
    };
    /**
     * 退出
     * @constructor
     * @param {Function} callback
     */
    MediaCloudJSSDK.prototype.nativeGoBackjs = function (callback) {
        normalEventBind(this._event, 'nativeGoBackjs', callback);
        this._request('nativeGoBackjs');
    };
    /**
     * 登陆
     * @constructor
     ...
     * @constructor
     * @param {Object} option
     * @param {String} option.tv_program_name     推送标题
     * @param {String} option.time      推送内容
     * @param {String} option.h5       推送链接
     * @param {String} option.mId       唯一标识
     */
    MediaCloudJSSDK.prototype.addSubscribeNotice = function (option) {
        option = option || {};
        option.type = 0;
        this._request('addSubscribeNotice', option);
    };
     ...
     * @param {String} option.mId       唯一标识
     */
    MediaCloudJSSDK.prototype.removeSubscribeNotice = function (option) {
        option = option || {};
        option.type = 0;
        this._request('removeSubscribeNotice', option);
    };
     ...
     * @param {Function} callback
     */
    MediaCloudJSSDK.prototype.pressShake = function (callback) {
        normalEventBind(this._event, 'pressShake', callback);
        this._request('pressShake');
    };
    /**
     * 预览图片
     * @constructor
